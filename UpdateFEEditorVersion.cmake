# ============================================================================
# UpdateFEEditorVersion.cmake
# 
# Pre-build script that generates version information for Focal Engine Editor.
# Runs every build to capture: git commit counts, branch, hash,
# dirty status and timestamp. Outputs are written to FEEditorVersion.h via configure_file.
#
...
set(EDITOR_VERSION_MAJOR 0)
set(EDITOR_VERSION_MINOR 1)
set(EDITOR_VERSION_PATCH 7)
...
if(GIT_FOUND)
    ...
    set(EDITOR_MASTER_COMMIT_COUNT 0)
    set(EDITOR_BRANCH_COMMIT_COUNT 0)
    set(EDITOR_GIT_HASH "unknown")
    set(EDITOR_GIT_BRANCH "unknown")
    set(EDITOR_GIT_DIRTY 0)
endif()
...
if("${EDITOR_GIT_BRANCH}" STREQUAL "HEAD")
    ...
    if(NOT "${EDITOR_GIT_BRANCH}" STREQUAL "")
        string(REGEX MATCH "[^ \n]+" EDITOR_GIT_BRANCH "${EDITOR_GIT_BRANCH}")
        string(REGEX REPLACE "^origin/" "" EDITOR_GIT_BRANCH "${EDITOR_GIT_BRANCH}")
    else()
        set(EDITOR_GIT_BRANCH "detached")
    endif()
endif()
